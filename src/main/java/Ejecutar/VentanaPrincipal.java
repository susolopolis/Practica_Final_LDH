...
public class VentanaPrincipal extends JFrame {
    ...
    protected JList<Objeto_Casa> listObjetos;
    protected DefaultListModel<Objeto_Casa> modelObjetos;
    private DefaultListModel<Objeto_Casa> modelObjetosGuardados;

    private JPanel pnBotones;
    private JPanel pnBtInferior;
    protected JButton btRecuperar;
    protected JButton btGuardar;
    private JPanel pnBtSuperior;
    protected JButton btCrear;
    protected JButton btActualizar;
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    LOGGER.log(Level.WARNING,"Error en el test...Revisar VentanaPrincipal.java");
                }
            }
        });
    }
    ...
    public VentanaPrincipal() {
        ...
        //setIconImage(Toolkit.getDefaultToolkit().getImage(VentanaPrincipal.class.getResource("src/Codigo/img/ObjectTrackingIcon.png")));
    ...
    public JPanel getPnLocalizacion() {
    ...
    public JLabel getLbListaObjetos() {
    ...
    public JScrollPane getScrollPaneListaObjetos() {
    ...
    public JList<Objeto_Casa> getListObjetos() {
        if (listObjetos == null) {
    ...
    public JLabel getLbInformacionObjetos() {
    ...
    public JCheckBox getChckbxEditar() {
    ...
    public JTextField getTxPosicionX() {
        if (txPosicionX == null) {
    ...
    public JTextField getTxPosicionY() {
        if (txPosicionY == null) {
    ...
    public VentanaPrincipal getReferenciaThis() {
        return this;
    }
}